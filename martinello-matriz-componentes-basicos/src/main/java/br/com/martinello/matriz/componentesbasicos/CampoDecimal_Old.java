...
public class CampoDecimal_Old extends JTextField implements Campo, FocusListener {
    ...
    public CampoDecimal_Old() {
        this(null, null, null, false, MONETARY_FORMAT);
    }

    public CampoDecimal_Old(Class tabela, String campo, String descricaoRotulo) {
        this(tabela, campo, descricaoRotulo, false, MONETARY_FORMAT);
    }

    public CampoDecimal_Old(Class tabela, String campo, String descricaoRotulo, boolean obrigatorio) {
        this(tabela, campo, descricaoRotulo, obrigatorio, MONETARY_FORMAT);
    }

    public CampoDecimal_Old(Class tabela, String campo, String descricaoRotulo, boolean obrigatorio, NumberFormat format) {
        this(tabela, campo, descricaoRotulo, obrigatorio, format, null);
    }

    public CampoDecimal_Old(Class tabela, String campo, String descricaoRotulo, boolean obrigatorio, NumberFormat format, Rotulo rRotulo) {
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(CampoDecimal_Old.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
